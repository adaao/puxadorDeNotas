...
def main():
    ...
    now = datetime.now()
    separaArquivosNfePorDataDeEmissao(calculaAno(), calculaMesPassado(), diretorioNfe, diretorioBox, now)
    separaArquivosSatPorDataDeEmissao(calculaAno(), calculaMesPassado(), diretorioSat, diretorioBox, now)
